...
public class LinkedinDemo {
    public static void main(String[] args) {
        Linkedin system = Linkedin.getInstance();
        ...
        Member alice = Member.builder("Alice", "alice@example.com")
                ...
                .addExperience(new Experience("Sr. Software Engineer", "Google", YearMonth.of(2018, 1), null))
                .addExperience(new Experience("Software Engineer", "Microsoft", YearMonth.of(2014, 6), YearMonth.of(2017, 12)))
                .addEducation(new Education("Princeton University", "M.S. in Computer Science", YearMonth.of(2012, 6), YearMonth.of(2014, 6)))
                .build();

        Member bob = Member.builder("Bob", "bob@example.com")
                .withSummary("Product Manager at Stripe.")
                .addExperience(new Experience("Product Manager", "Stripe", YearMonth.of(2020, 2), null))
                .addEducation(new Education("MIT", "B.S. in Business Analytics", YearMonth.of(2015, 6), YearMonth.of(2019, 6)))
                .build();
        ...
        system.createPost(bob.getId(),  "Feature launch", "Excited to share we've launched our new feature! #productmanagement");
        ...
        if (bobsPost != null) {
            bobsPost.addReaction(alice, ReactionType.LIKE);
