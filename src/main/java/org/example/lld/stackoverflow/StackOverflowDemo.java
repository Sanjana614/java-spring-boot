...
public class StackOverflowDemo {
    ...
    public static void main(String[] args) {
        ...
        // Create users
        User alice = stackOverflow.addUser("Alice", "alice@example.com");
        User bob = stackOverflow.addUser("Bob", "bob@example.com");
        User charlie = stackOverflow.addUser("Charlie", "charlie@example.com");
        ...
        Answer bobAnswer = stackOverflow.postAnswer(bob.getUserId(), javaQuestion.getQuestionId(),
        ...
        stackOverflow.acceptAnswer(bobAnswer.getAnswerId());
